...
# l = [s, c, p, op, gi, grp, sgn, per, cur, opn, ocp, brc, bcp, bop, glm, svl]
# for i in l:
#     print(i)
...
if __name__ == "__main__":
    test = r" 123 -42 1e6 1.23e-4 1_000_000 1,234,567 1,234.56 01/21/2024 13:45 13:45:45:45 (1)−(2.3)-(3);($4) 1-2-3 123.45 .45 50.5% 5+3 1/2 10^6 $123 €12,345 123$ 1.2.3.4.454.45 1_234 1:302"
